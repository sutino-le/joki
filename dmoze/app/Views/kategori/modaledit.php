...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl rounded">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formKategoriSimpan') ?>" method="post" id="formEdit" class="formEdit" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="katnama" id="katnama" class="form-control" value="<?= $katnama ?>" placeholder="Enter Nama Kategori..." autocomplete="off">
...
<script>
    $(document).ready(function() {
        ...
        $('.formEdit').submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url('formKategoriUpdate') ?>',
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
