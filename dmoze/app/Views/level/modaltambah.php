...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl rounded">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formLevelSimpan') ?>" method="post" id="formTambah" class="formsimpan" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="levelnama" id="levelnama" class="form-control" placeholder="Enter Nama Level..." autocomplete="off">
