...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl rounded">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formMenuSimpan') ?>" method="post" id="formTambah" class="formsimpan" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="menunama" id="menunama" class="form-control" placeholder="Enter Nama Menu..." autocomplete="off">
                                ...
                                <div class="col-sm-8">
                                    <select name="menukategori" id="menukategori" class="form-control">
                                        ...
                                        <?php foreach ($dataKategori as $rowKategori) : ?>
                                            <option value="<?= $rowKategori['katid'] ?>"><?= $rowKategori['katnama'] ?>
                                            </option>
                                        <?php endforeach ?>
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="jenis_a" id="jenis_a" class="form-control" placeholder="Enter Jenis 1..." autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="harga_a" id="harga_a" class="form-control" placeholder="Enter Harga 1..." autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="jenis_b" id="jenis_b" class="form-control" placeholder="Enter Jenis 2..." autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="harga_b" id="harga_b" class="form-control" placeholder="Enter Harga 2..." autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="jenis_c" id="jenis_c" class="form-control" placeholder="Enter Jenis 3..." autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="harga_c" id="harga_c" class="form-control" placeholder="Enter Harga 3..." autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
