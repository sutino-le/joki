...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl rounded">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formUserSimpan') ?>" method="post" id="formTambah" class="formsimpan" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="userid" id="userid" class="form-control" placeholder="Enter ID User..." autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="usernama" id="usernama" class="form-control" placeholder="Enter Nama User..." autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="email" name="useremail" id="useremail" class="form-control" placeholder="Enter Email..." autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="userhp" id="userhp" class="form-control" placeholder="Enter Nomor HP..." autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="userpassword" id="userpassword" class="form-control" placeholder="Enter Password..." autocomplete="off">
