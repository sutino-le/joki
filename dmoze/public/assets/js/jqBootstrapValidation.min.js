          ...
          return (
            a(s).bind("submit", function (e) {
              ...
              o
                ...
                o.each(function (e, t) {
                  var i = a(t).parents(".form-group").first();
                  i.hasClass("warning") &&
                    (i.removeClass("warning").addClass("error"), n++);
                }),
                o.trigger("validationLostFocus.validation"),
                n
                  ? (t.options.preventSubmit && e.preventDefault(),
                    i.addClass("error"),
                    a.isFunction(t.options.submitError) &&
                      t.options.submitError(
                        i,
                        e,
                        o.jqBootstrapValidation("collectErrors", !0)
                      ))
                  : (i.removeClass("error"),
                    a.isFunction(t.options.submitSuccess) &&
                      t.options.submitSuccess(i, e));
            }),
            this.each(function () {
              var e = a(this),
              ...
              if (
                (!l.length &&
                  t.options.autoAdd &&
                  t.options.autoAdd.helpBlocks &&
                  ((l = a('<div class="help-block" />')),
                  n.find(".controls").append(l),
                  i.push(l[0])),
                t.options.sniffHtml)
              ) {
                var c = "";
                if (
                  (void 0 !== e.attr("pattern") &&
                    ...
                    e.data("validationPatternMessage") &&
                      (c = e.data("validationPatternMessage")),
                    e.data("validationPatternMessage", c),
                    e.data("validationPatternRegex", e.attr("pattern"))),
                  void 0 !== e.attr("max") ||
                    void 0 !== e.attr("aria-valuemax"))
                ) {
                  var v =
                    void 0 !== e.attr("max")
                      ? e.attr("max")
                      : e.attr("aria-valuemax");
                  (c =
                    "Too high: Maximum of '" +
                    v +
                    "'\x3c!-- data-validation-max-message to override --\x3e"),
                    e.data("validationMaxMessage") &&
                      (c = e.data("validationMaxMessage")),
                    e.data("validationMaxMessage", c),
                    e.data("validationMaxMax", v);
                }
                if (
                  void 0 !== e.attr("min") ||
                  void 0 !== e.attr("aria-valuemin")
                ) {
                  var u =
                    void 0 !== e.attr("min")
                      ? e.attr("min")
                  ...
                  (c =
                    ...
                    e.data("validationMinMessage") &&
                      (c = e.data("validationMinMessage")),
                ...
                void 0 !== e.attr("maxlength") &&
                  ...
                  e.data("validationMaxlengthMessage") &&
                    (c = e.data("validationMaxlengthMessage")),
                  ...
                  void 0 !== e.attr("minlength") &&
                    ...
                    e.data("validationMinlengthMessage") &&
                      (c = e.data("validationMinlengthMessage")),
                    e.data("validationMinlengthMessage", c),
                    e.data(
                      "validationMinlengthMinlength",
                      e.attr("minlength")
                    )),
                  (void 0 === e.attr("required") &&
                    void 0 === e.attr("aria-required")) ||
                    ((c = t.builtInValidators.required.message),
                    e.data("validationRequiredMessage") &&
                      (c = e.data("validationRequiredMessage")),
                    e.data("validationRequiredMessage", c)),
                  void 0 !== e.attr("type") &&
                    "number" === e.attr("type").toLowerCase() &&
                    ((c = t.builtInValidators.number.message),
                    e.data("validationNumberMessage") &&
                      (c = e.data("validationNumberMessage")),
                    e.data("validationNumberMessage", c)),
                  void 0 !== e.attr("type") &&
                    "email" === e.attr("type").toLowerCase() &&
                    ((c =
                      "Not a valid email address\x3c!-- data-validator-validemail-message to override --\x3e"),
                    e.data("validationValidemailMessage")
                      ? (c = e.data("validationValidemailMessage"))
                      : e.data("validationEmailMessage") &&
                        (c = e.data("validationEmailMessage")),
                  ...
                  void 0 !== e.attr("minchecked") &&
                    ...
                    e.data("validationMincheckedMessage") &&
                      (c = e.data("validationMincheckedMessage")),
                  ...
                  void 0 !== e.attr("maxchecked") &&
                    ...
                    e.data("validationMaxcheckedMessage") &&
                      (c = e.data("validationMaxcheckedMessage")),
              ...
              void 0 !== e.data("validation") &&
                (d = e.data("validation").split(",")),
                ...
                a.each(d, function (a, e) {
                  ...
                  a.each(m, function (i, n) {
                    if (void 0 !== e.data("validation" + n + "Shortcut"))
                      a.each(
                        e.data("validation" + n + "Shortcut").split(","),
                        function (a, e) {
                          g.push(e);
                        }
                      );
              ...
              a.each(d, function (i, n) {
                ...
                if (
                  ...
                  a.each(t.validatorTypes, function (t, i) {
                    void 0 === h[t] && (h[t] = []),
                      s ||
                        void 0 === e.data("validation" + n + o(i.name)) ||
                        (h[t].push(
                          a.extend(
                            !0,
                            { name: o(i.name), message: r },
                            i.init(e, n)
                          )
                        ),
                        (s = !0));
                  ...
                  var d = a.extend(
                    !0,
                    {},
                    t.builtInValidators[n.toLowerCase()]
                  );
                  l && (d.message = r);
                    ...
                    : a.each(t.validatorTypes, function (t, i) {
                        void 0 === h[t] && (h[t] = []),
                          s ||
                            c !== t.toLowerCase() ||
                            (e.data(
                              "validation" + n + o(i.name),
                              d[i.name.toLowerCase()]
                            ),
                            h[c].push(a.extend(d, i.init(e, n))),
                            (s = !0));
                      });
                }
                  ...
                  return (
                    a.each(h, function (i, r) {
                      (o ||
                        o.length ||
                        (n && n.includeEmpty) ||
                        (t.validatorTypes[i].blockSubmit &&
                          n &&
                          n.submitting)) &&
                        a.each(r, function (a, n) {
                          t.validatorTypes[i].validate(e, o, n) &&
                            l.push(n.message);
                        });
                    }),
                    l
                ...
                e.bind(
                  ...
                  function (i, o) {
                    ...
                    n.find("input,textarea,select").each(function (t, i) {
                      ...
                      if (
                        (a.each(
                          a(i).triggerHandler("validation.validation", o),
                          function (a, e) {
                            c.push(e);
                          }
                        ),
                      ...
                      (c = a.unique(c.sort())).length
                        ? (n.removeClass("success error").addClass("warning"),
                          t.options.semanticallyStrict && 1 === c.length
                            ? l.html(
                                c[0] +
                                  (t.options.prependExistingHelpBlock
                                    ? l.data("original-contents")
                                    : "")
                              )
                            : l.html(
