                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="usernama" id="usernama" class="form-control"
                                    value="<?= $usernama ?>" placeholder="Masukan Nama..." autocomplete="off">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="useremail" id="useremail" class="form-control"
                                    value="<?= $useremail ?>" placeholder="Masukan Email..." autocomplete="off">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="useralamat" id="useralamat" class="form-control"
                                    value="<?= $useralamat ?>" placeholder="Masukan Alamat..." autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="userpassword" id="userpassword" class="form-control"
                                    value="<?= $userpassword ?>" placeholder="Masukan Kata Sandi..." autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <select name="userlevel" id="userlevel" class="form-control">
                                    ...
                                    <option value="<?= $rowLevel['levelid'] ?>"
                                        <?= ($userlevel==$rowLevel['levelid']) ?"selected" : "" ?>>
