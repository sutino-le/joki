...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formEditMenuSimpan') ?>" method="post" id="formEdit" class="formsimpan"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="menunama" id="menunama" class="form-control" value="<?= $menunama ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="menuharga" id="menuharga" class="form-control"
                            value="<?= $menuharga ?>" placeholder="Masukan Harga..." autocomplete="off">
...
$(document).ready(function() {
    ...
    $('.formsimpan').submit(function(e) {
        ...
        $.ajax({
            type: "post",
            url: '<?= base_url('formEditMenuSimpan') ?>',
            data: formData,
            contentType: false,
            processData: false,
            dataType: "json",
