...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formTambahLokasiSimpan') ?>" class="formsimpan">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="loknama" id="loknama" class="form-control"
                            placeholder="Masukan Nama Lokasi..." autocomplete="off">
                        <div class="invalid-feedback errorLokasiNama"></div>
                    </div>

                    <div class="form-group">
                        <label for="">Link Lokasi</label>
                        <textarea name="loklink" id="loklink" class="form-control"
                            placeholder="Masukan Link..."></textarea>
                        <div class="invalid-feedback errorLokasiLink"></div>
                    </div>

                    <div class="form-group">
                        <label for="">Deskripsi</label>
                        <input type="text" name="lokdeskripsi" id="lokdeskripsi" class="form-control"
                            placeholder="Masukan Deskripsi..." autocomplete="off">
                    </div>
