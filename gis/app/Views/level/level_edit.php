...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formEditLevelSimpan') ?>" class="formsimpan">
                <?= csrf_field(); ?>

                <input type="hidden" name="levelid" id="levelid" value="<?= $levelid ?>">

                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Data Level</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="levelnama" id="levelnama" class="form-control"
                            value="<?= $levelnama ?>" placeholder="Masukan Nama Level..." autocomplete="off">
