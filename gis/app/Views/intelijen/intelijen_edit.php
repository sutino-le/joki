...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('formEditIntelijenSimpan') ?>" class="formsimpan">
                <?= csrf_field(); ?>


                <input type="hidden" name="intel_id" id="intel_id" value="<?= $intel_id ?>">

                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="staticBackdropLabel">Rubah Data Intelijen</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="intel_judul" id="intel_judul" class="form-control"
                            value="<?= $intel_judul ?>" placeholder="Masukan Judul..." autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="intel_tanggal" id="intel_tanggal" class="form-control"
                            value="<?= $intel_tanggal ?>" placeholder="Masukan Nama Intelijen..." autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="intel_deskripsi" id="intel_deskripsi" class="form-control"
                            placeholder="Masukan Deskripsi..."><?= $intel_deskripsi ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="intel_katid" id="intel_katid" class="form-control">
                            ...
                            <option value="<?= $rowKategori['katid'] ?>"
                                <?= ($intel_katid == $rowKategori['katid']) ? 'selected' : "" ?>>
                                <?= $rowKategori['katnama'] ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="intel_lokid" id="intel_lokid" class="form-control">
                            ...
                            <option value="<?= $rowLokasi['lokid'] ?>"
                                <?= ($intel_lokid == $rowLokasi['lokid']) ? 'selected' : "" ?>>
                                <?= $rowLokasi['loknama'] ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="intel_level" id="intel_level" class="form-control">
                            ...
                            <option value=""></option>
                            <option value="Rendah" <?= ($intel_level == "Rendah") ? 'selected' : "" ?>>Rendah</option>
                            <option value="Sedang" <?= ($intel_level == "Sedang") ? 'selected' : "" ?>>Sedang</option>
                            <option value="Tinggi" <?= ($intel_level == "Tinggi") ? 'selected' : "" ?>>Tinggi</option>
                        </select>
